...
# coq_makefile abstract_machine.v abstract_machine_facts.v lam_cl_es_no.v lam_cl_es_no_tests.v lam_kes_cbn.v lam_no.v lam_no_check.v lam_ses_no.v lam_ses_no_check.v miniml.v miniml_check.v reduction_semantics.v reduction_semantics_facts.v reduction_semantics_props.v reduction_strategy.v refocusing_lang.v refocusing_machine.v refocusing_machine_facts.v refocusing_machine_safe_reg.v refocusing_natural_semantics.v refocusing_natural_semantics_facts.v refocusing_semantics.v refocusing_semantics_derivation.v refocusing_semantics_facts.v Util.v -o Makefile 
#
