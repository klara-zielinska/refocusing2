...
Module MiniML_PreLang <: RED_SYNTAX.
...
Module MiniML_Strategy <: STRATEGY_STEP MiniML_PreLang.
...
Module MiniML_Ref_minus <: RED_REF_LANG_minus.
  ...
  Module SX := MiniML_PreLang.
  Module ST := MiniML_Strategy.
  Module RSF := RED_SYNTAX_Facts SX.
  Export MiniML_PreLang MiniML_Strategy.
  Import RSF.
  ...
  Proof with auto.
    ...
    - destruct (IHc _ H) as (H1, H2)...
      dep_subst.
      solve [ destruct ec0; inversion H ].
  Qed.
...
Module MiniML_RefSem := RedRefSem MiniML_Ref.
Module MiniML_EAM    := ProperEAMachine MiniML_Ref.R MiniML_RefSem.
